...
figure
plot(flatLQRTime,flatLQRRoll)
title('Flat Test Roll Angle (No VMSD)')
xlabel('Time (s)')
ylabel('Roll Angle (rad)')
legend('Flat No VMSD')
figure
plot(rutLQRTime,rutLQRRoll)
title('Rut Test Roll Angle (No VMSD)')
xlabel('Time (s)')
ylabel('Roll Angle (rad)')
legend('Rut No VMSD')
figure
plot(flatLQRTime,flatLQRLean)
title('Flat Test Lean Angle (No VMSD)')
xlabel('Time (s)')
ylabel('Lean Angle (rad)')
legend('Flat No VMSD')
figure
plot(rutLQRTime,rutLQRLean)
title('Rut Test Lean Angle (No VMSD)')
xlabel('Time (s)')
ylabel('Lean Angle (rad)')
legend('Rut No VMSD')
figure
plot(flatLQRTime,flatLQRTorque)
title('Flat Test Lean Torque (No VMSD)')
xlabel('Time (s)')
ylabel('Torque (Nm)')
legend('Flat No VMSD')
figure
plot(rutLQRTime,rutLQRTorque)
title('Rut Test Lean Torque (No VMSD)')
xlabel('Time (s)')
ylabel('Torque (Nm)')
legend('Rut No VMSD')
